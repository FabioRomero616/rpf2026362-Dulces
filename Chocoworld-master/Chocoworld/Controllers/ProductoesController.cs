...
namespace Chocoworld.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ProductoesController(ChocomundoContext context)
        {
            _context = context;
        }
        ...
        {
            var chocomundoContext = _context.Productos.Include(p => p.Categoria);
        ...
        public async Task<IActionResult> Create([Bind("ProductoId,Nombre,Descripcion,Precio,CategoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductoId,Nombre,Descripcion,Precio,CategoriaId")] Producto producto)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ChocomundoContext.Productos'  is null.");
            }
            var producto = await _context.Productos.FindAsync(id);
            if (producto != null)
            {
