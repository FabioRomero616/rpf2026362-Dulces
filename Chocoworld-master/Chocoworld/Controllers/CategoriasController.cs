...
namespace Chocoworld.Controllers
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(ChocomundoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string buscar)
        {
            ...
            {
                categorias = categorias.Where(categoria => categoria.Nombre.Contains(buscar));
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ChocomundoContext.Categorias'  is null.");
            }
            var categoria = await _context.Categorias.FindAsync(id);
            if (categoria != null)
            {
